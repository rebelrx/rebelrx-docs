...
This site provides **educational and informational content only**.

You agree to:

- Use the site lawfully  
- Not misuse, disrupt, or attempt to compromise the site  
- Not attempt unauthorized access to any systems or infrastructure  
...
You should consult a qualified professional before making decisions based on this content.
...
RebelRx makes no guarantees regarding:
...
RebelRx shall not be liable for any damages arising from:
...
All content on this site, unless otherwise stated, is owned by RebelRx.
...
- Content is informational, not professional advice  
- No guarantees  
- You use it at your own risk  

> Simple rule: use the information, but don’t rely on it blindly.
